...
urlpatterns = [
    url(r'^$',                 translator_views.vending_dashboard, name='dashboard'),
    url(r'^landing/?$',        translator_views.landing,           name='landing'),
    ...
    url(r'^api/vending/dispatch/(?P<sim_code>[\w\-.]+)/$',     vending_api.vending_dispatch_api,     name='vending_dispatch_api'),
